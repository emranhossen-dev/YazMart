...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 text-slate-100 font-sans antialiased relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-blue-600/20 blur-[120px] pointer-events-none" />
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 relative z-10">
        <div className="w-full max-w-md p-6 sm:p-8 rounded-3xl border border-slate-800 bg-slate-900/90 backdrop-blur-xl shadow-2xl space-y-6">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-white hover:bg-slate-100 text-slate-900 rounded-2xl text-xs font-black uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-3 shadow-md border border-slate-200 disabled:opacity-50"
          >
          ...
          <div className="relative flex items-center justify-center">
            ...
            <span className="bg-slate-900 px-3 text-[10px] font-black uppercase text-slate-500 tracking-widest shrink-0">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    name="fullName"
                    required
                    className="pl-10 pr-4 py-2.5 text-xs rounded-2xl bg-slate-950 border border-slate-800 w-full focus:outline-none focus:border-[#ff6600] font-semibold text-white placeholder-slate-600"
