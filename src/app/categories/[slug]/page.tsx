...
import { ShoppingCart, Heart, Eye, ArrowLeft, Search, Sliders, Layers, ShoppingBag } from "lucide-react";
        ...
        <aside className="space-y-5 bg-[var(--card)] border border-[var(--border)] rounded-xl p-5 shadow-xs h-fit">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="pl-8 pr-3 py-1.5 text-xs rounded bg-[var(--background)] border border-[var(--border)] w-full focus:outline-none focus:border-blue-500 font-medium"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              <input 
                ...
                className="px-2 py-1.5 text-xs rounded bg-[var(--background)] border border-[var(--border)] focus:outline-none focus:border-blue-500 font-bold" 
              />
              <input 
                type="number" 
                placeholder="Max" 
          ...
          <div className="space-y-1">
            ...
            <select 
              ...
              className="px-2 py-1.5 text-xs rounded bg-[var(--background)] border border-[var(--border)] w-full focus:outline-none font-bold"
            >
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {products.map((product) => {
                ...
                return (
                  <div 
                    key={product.id}
                    className="rounded-xl border border-[var(--border)] bg-[var(--card)] flex flex-col overflow-hidden shadow-sm hover:shadow-md transition-all group relative"
                  >
                    {/* Discount badge */}
                    {discount && (
                    ...
                    <button 
                      ...
                      className="absolute top-2 right-2 z-10 p-1.5 rounded-full bg-[var(--card)] border border-[var(--border)] hover:text-rose-500 transition-colors shadow-xs cursor-pointer"
                    >
                        ...
                        {product.current_stock > 0 ? (
                          <div className="flex gap-1">
                            ...
                            <Link 
                              ...
                              className="p-1.5 bg-[var(--background)] hover:bg-[var(--accent)] border border-[var(--border)] rounded-lg text-[var(--foreground)] cursor-pointer animate-fade-in"
                            >
